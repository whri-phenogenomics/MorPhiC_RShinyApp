  ...
  return(
    plots_info = list(
      tagList(
        ...
        # p('MGI viability: Outcome of gene knockout on mouse survival. If there is any evidence for lethality in the mouse KO line, then the gene will be labeled with a "lethal" annotation'),
