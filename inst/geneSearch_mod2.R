...
<div class="container-fluid pt-2 pb-2">
  <div class="row">
    <div class="col-md-auto border border-dark rounded mb-4" style="border: 8px solid #414141; background-color: #fff;">
  
      <div class="row">
        <div id ="gene_info_left_col", class="col">
    <h3 class="font-weight-bold text-black" style="font-size: 22px;">
        <span style="background-color: #007bff; color: #000; padding: 5px;">Gene info</span>
          ...
          <h3 class="font-weight-bold" style="font-size: 18px;">{is_morphic}</h3>
        </div>
      </div>
    </div>

    <div id = "search_right_col", class="col-md-6 border border-dark rounded mb-4" style="border: 8px solid #414141; background-color: #fff;">
  ...
  <h3 class="font-weight-bold text-black" style="font-size: 22px;">
        ...
        <div class="col-md-6">
          ...
          <h3 class="font-weight-bold" style="font-size: 18px;">Human-Mouse 1-1 Ortholog: {impc_one2one_ortholog}</h3>
