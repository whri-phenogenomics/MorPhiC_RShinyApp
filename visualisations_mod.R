...
visualisationsPageUI <- function(id) {
  ...
  tabsetPanel(
    tabPanel(HTML("DPCs Genes of Interest<br><span style='font-size: 14px;'>&nbsp;</span>"), id = "upset_plot_tab",
             ...
             fluidRow(
               column(
                 width =9,
                 plotOutput(NS(id, "upsetplot"), height = "60vh")
               )
             )
    ),
    ...
    tabPanel(HTML("Mouse Model Data<br><span style='font-size: 14px;'>&nbsp;</span>"), id = "viability_tab",
             fluidRow(
               column(
                 width = 9,
                 uiOutput(NS(id, "viability_text"))
               )
             ),
             hr(),
             fluidRow(
               column(width = 9, plotlyOutput(NS(id, "viability_plot"), height = "60vh")),
               column(
                 width = 3,
                 box(
                   width = 12,
             ...
             fluidRow(
               box(
                 ...
                 DTOutput(NS(id, 'impc_data_table'))
               )
             )
    ),
    ...
    tabPanel(HTML("Disease Data<br><span style='font-size: 14px;'>&nbsp;</span>"), id = "omim_tab",
             fluidRow(
               column(
                 width = 9,
                 uiOutput(NS(id, "disease_text"))
               )
             ),
             hr(),
             fluidRow(
               column(width = 9, plotlyOutput(NS(id, "omim_plot"), height = "60vh")),
               column(
                 width = 3,
                 box(
                   width = 12,
             ...
             fluidRow(
               box(
                 ...
                 DTOutput(NS(id, 'omim_data_table'))
               )
             )
    ),
    ...
    tabPanel(HTML("PANTHERdb<br><span style='font-size: 14px;'>(Protein Data)</span>"), id = "panther_tab",
             ...
             fluidRow(
               conditionalPanel(
                 ...
                 column(width = 9, plotlyOutput(NS(id, "panther_plot"), height = "60vh"))
               ),
               conditionalPanel(
                 condition = "input.center_panther == 'all centers'",
                 column( width = 9,
                         fluidRow(width = 12,
                                  splitLayout(cellWidths = c("50%", "50%"),
                                              plotlyOutput(NS(id, "panther_jax_plot")), plotlyOutput(NS(id, "panther_msk_plot")))),
                         fluidRow(width = 12,
                                  splitLayout(cellWidths = c("50%", "50%"),
                                              plotlyOutput(NS(id, "panther_nwu_plot")), plotlyOutput(NS(id, ("panther_ucsf_plot"))))
                 )
               ),
               column(
                 width = 3,
             ...
             fluidRow(
               box(
                 ...
                 DTOutput(NS(id, 'panther_data_table'))
               )
             )
    )),
    ...
    tabPanel(HTML("Cellular Core Essentiality Data<br><span style='font-size: 14px;'>&nbsp;</span>"), id = "cell_essentiality_plot_tab",
             fluidRow(
               column(
                 width = 9,
                 uiOutput(NS(id, "cell_essential_text"))
               )
             ),
             hr(),
             fluidRow(
               column(width = 9, plotlyOutput(NS(id, "cell_essentiality_plot"), height = "60vh")),
               column(
                 width = 3,
                 box(
                   width = 12,
                   ...
                   status = "primary",
                   selectInput(
                     NS(id, "center_cell_essentiality_barchart"),
                     "Select gene list:",
                     choices = c("all morphic", "jax", "msk", "nwu", "ucsf", "all centers"),
                     selected = "all morphic"  # Set the default selected option
                   )
             ...
             fluidRow(
               box(
                 ...
                 DTOutput(NS(id, 'cell_essentiality_data_table'))
               )
             )
    ),
    ...
    tabPanel(HTML("Gene Onotology<br><span style='font-size: 14px;'>(Semantic Similarity Analysis)</span>"), id = "go_scatter_tab",
             ...
             fluidRow(
               conditionalPanel(
                 ...
                 column(width = 9, div(style='overflow-x: scroll', plotlyOutput(NS(id, "go_scatter"), height = "60vh")))
               ),
               conditionalPanel(
                 condition = "input.center_go == 'all centers'",
                 column( width = 9,
                         fluidRow(width = 12,
                                  splitLayout(cellWidths = c("50%", "50%"),
                                              div(style='overflow-x: scroll', plotlyOutput(NS(id, "go_jax_plot"))), plotlyOutput(NS(id, "go_msk_plot")))),
                         fluidRow(width = 12,
                                  splitLayout(cellWidths = c("50%", "50%"),
                                              plotlyOutput(NS(id, "go_nwu_plot")), plotlyOutput(NS(id, "go_ucsf_plot"))))
                 )
               ),
               column(
                 width = 3,
    ...
    tabPanel(HTML("Reactome<br><span style='font-size: 14px;'>(Enrichment Analysis)</span>"), id = "reactome_emapplot_tab",
             ...
             fluidRow(
               conditionalPanel(
                 ...
                 column(width = 9, plotOutput(NS(id, "reactome_emapplot"), height = "60vh"))
               ),
               conditionalPanel(
                 condition = "input.center_reactome == 'all centers'",
                 column( width = 9,
                         fluidRow(width = 12,
                                  splitLayout(cellWidths = c("50%", "50%"),
                                              plotOutput(NS(id, "jax_reactome_emapplot")), plotOutput(NS(id, "msk_reactome_emapplot")))),
                         fluidRow(width = 12,
                                  splitLayout(cellWidths = c("50%", "50%"),
                                              plotOutput(NS(id, "nwu_reactome_emapplot")), plotOutput(NS(id, "ucsf_reactome_emapplot"))))
                 )
               ),
               column(
                 width = 3,
             ...
             fluidRow(
               box(
                 ...
                 DTOutput(NS(id, 'reactome_data_table'))
               )
             )
    ),
    ...
    tabPanel(HTML("Cellular Core Essentiallity<br><span style='font-size: 14px;'>(Cell Line Data)</span>"), id = "cell_essentiality_boxplots_tab",
             ...
             fluidRow(
               column(
                 width = 9,
                 fluidRow(
                   column(12, box(plotlyOutput(NS(id, "cell_essentiality_boxplot_depmap"), height = "40vh"), title = "Mean gene effect score/corrected CERES score", solidHeader = TRUE, collapsible = TRUE, collapsed = FALSE, width = 12)) # Adjust height as needed
                 ),
                 hr(),
                 fluidRow(
                   column(12, box(plotlyOutput(NS(id, "cell_essentiality_boxplot_mef"), height = "40vh"), title = "Bayes Factor (MEF feeder cell fed hPSCs)", solidHeader = TRUE, collapsible = TRUE, collapsed = TRUE, width = 12))    # Adjust height as needed
                 ),
                 hr(),
                 fluidRow(
                   column(12, box(plotlyOutput(NS(id, "cell_essentiality_boxplot_laminin"), height = "40vh"), title = "Bayes Factor (Laminin fed hPSCs)", solidHeader = TRUE, collapsible = TRUE, collapsed = TRUE, width = 12))    # Adjust height as needed
                 ),
                 hr()
               ...
               column(
                 ...
                 box(
                   ...
                   status = "primary",
                   selectInput(
                     NS(id, "center_cell_essentiality_boxplots"),
                     "Select gene list:",
                     choices = c("all morphic", "jax", "msk", "nwu", "ucsf", "all centers"),
                     selected = "all morphic"  # Set the default selected option
                   ),
                   selectInput(
                     NS(id, "cell_essential_depmap_significance_threshold"),
                     "Select significance threshold for DepMap data:",
                     choices = c("-0.5", "-1"),
                     selected = "-0.5"  # Set the default selected option
                   ),
                   textInput(NS(id, "search_gene_symbol_cell"), "Search Gene symbol:", placeholder = "DLX3"),
                   checkboxInput(NS(id, "compare_protein_coding_genes"), label = "Compare to all protein coding genes")
                 )
               )
             )
    ...
    tabPanel(HTML("Cellular Core Essentiallity<br><span style='font-size: 14px;'>(Sequencing Data)</span>"), id = "gene_constraint_metrics_tab",
             fluidRow(
               column(
                 width = 9,
                 uiOutput(NS(id, "cell_sequencing_text"))
               )
             ),
             hr(),
             fluidRow(
               column(
                 width = 9,
                 fluidRow(column(12, box(plotlyOutput(NS(id, "gene_constraint_oe_lof"), height = "40vh"), title = "Observed/expected Loss-of-function variants score", solidHeader = TRUE, collapsible = TRUE, collapsed = FALSE, width = 12))),
                 hr(),
                 fluidRow(column(12, box(plotlyOutput(NS(id, "gene_constraint_oe_mis"), height = "40vh"), title = "Observed/expected Missense variants score", solidHeader = TRUE, collapsible = TRUE, collapsed = TRUE, width = 12))),
                 hr(),
                 fluidRow(column(12, box(plotlyOutput(NS(id, "gene_constraint_shet_rgcme"), height = "40vh"), title = "Shet RGC-ME score", solidHeader = TRUE, collapsible = TRUE, collapsed = TRUE, width = 12))),
                 hr(),
                 fluidRow(column(12, box(plotlyOutput(NS(id, "gene_constraint_shet_posterior"), height = "40vh"), title = "Shet Posterior score", solidHeader = TRUE, collapsible = TRUE, collapsed = TRUE, width = 12))),
                 hr(),
                 fluidRow(column(12, box(plotlyOutput(NS(id, "gene_constraint_domino"), height = "40vh"), title = "DOMINO score", solidHeader = TRUE, collapsible = TRUE, collapsed = TRUE, width = 12))),
                 hr(),
                 fluidRow(column(12, box(plotlyOutput(NS(id, "gene_constraint_scones"), height = "40vh"), title = "SCoNeS score", solidHeader = TRUE, collapsible = TRUE, collapsed = TRUE, width = 12))),
                 hr(),
               ),
               column(
                 width = 3,
                 box(
                   ...
                   status = "primary",
                   selectInput(
                     NS(id, "center_gene_constraint_seq"),
                     "Select gene list:",
                     choices = c("all morphic", "jax", "msk", "nwu", "ucsf", 'all centers'),
                     selected = "all morphic"  # Set the default selected option
                   ),
                   textInput(NS(id, "search_gene_symbol_seq"), "Search Gene:", placeholder = "DLX3"),
                   checkboxInput(NS(id, "compare_protein_coding_genes_gene_constraint_seq"), label = "Compare to all protein coding genes")
                 )
               )
             )
...
# SERVER ---------------------------------------------------------------------------------------------------------------------------------------------
visualisationsPageServer <- function(id) {
  moduleServer(id, function(input, output, session) {

    app_data_table <- readRDS("./rda_data/app_data_table.rda") # for data tables underneath summary plots
